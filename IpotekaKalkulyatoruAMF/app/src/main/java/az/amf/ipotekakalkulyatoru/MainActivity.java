...
//	/Users/agshin/Documents/adt/adt-bundle-mac-x86_64-20131030/sdk
	String m_qiymet;
	String m_kredit;
	String m_ilkin;
	String m_ayliq;
...
//	    actionBar.setDisplayHomeAsUpEnabled(true);
		...
		btn_umumi.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				btn_umumi.setTextColor(Color.WHITE);
				btn_guzewt.setTextColor(Color.BLACK);
		...
		btn_guzewt.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				btn_guzewt.setTextColor(Color.WHITE);
				btn_umumi.setTextColor(Color.BLACK);
	...
	{
		float c4 = gelir;//oihqo3iurhntp;34t
		float c5 = aile_uzv_say;
		float c12 = 136;//116//125; //min emekhaqqi;
		float c6 = diger_ohd;
		float c11h;
